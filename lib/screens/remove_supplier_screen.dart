...
class RemoveSupplierScreen extends StatefulWidget {
  const RemoveSupplierScreen({super.key});

  @override
  State<RemoveSupplierScreen> createState() => _RemoveSupplierScreenState();
}

class _RemoveSupplierScreenState extends State<RemoveSupplierScreen> {
                      ...
                      child: FloatingActionButton.extended(
                        onPressed: () async {
                          ...
                          if(_idC.text.trim().isEmpty ){
                            ...
                            // print(gender);
                            var i = await instance.removeSupplierWithId(int.parse(_idC.text));
                            if(i==0) {
                                isAnyError=true;
                                setState(() {
